...
The user: Female, 18 years old. Diets: vegan. Goals: Reduce stress. Extra information: doesn't like mushrooms and eggplants.\n
The result planner:
{
    "Sunday": {
        "Breakfast": {
        ...
        "Dinner": {
            ...
            "instructions": [
                ...
                "Mix rice, corn, and diced tomatoes.",
    ...
    "Monday": {
        ...
        "Dinner": {
            ...
            "instructions": [
                ...
                "Add kale and soy sauce, and stir-fry until kale is wilted."
            ]
        }
    },
    "Tuesday": {
        ...
        "Dinner": {
            ...
            "instructions": [
                ...
                "Mix cooked quinoa with diced tomatoes and nutritional yeast.",
                "Stuff zucchinis with the mixture and place on a baking sheet.",
    ...
    "Wednesday": {
        ...
        "Dinner": {
            ...
            "instructions": [
                ...
                "Add bell peppers and snap peas, and stir-fry until vegetables are tender.",
    ...
    "Thursday": {
        "Breakfast": {
            ...
            "instructions": [
                ...
                "Sprinkle with chia seeds and drizzle with agave syrup.",
                "Toss to mix."
            ]
        },
        "Lunch": {
            ...
            "instructions": [
                ...
                "Top with salsa and toss gently."
            ]
        },
        "Dinner": {
            ...
            "instructions": [
                ...
                "Add butternut squash, vegetable broth, cumin, and paprika.",
                "Bring to a boil, then simmer for 30 minutes until squash is tender.",
                "Blend until smooth using an immersion blender or blender."
            ]
        }
    },
    "Friday": {
    ...
    "Saturday": {
        ...
        "Lunch": {
            ...
            "instructions": [
                "Spread hummus over the tortilla.",
                "Layer with roasted vegetables and spinach.",
                "Roll up tightly and cut in half."
            ]
        },
        "Dinner": {
